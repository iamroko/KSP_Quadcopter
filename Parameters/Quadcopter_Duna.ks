...
declare global roll_kp is 1.3.
declare global roll_ki is 0.5.
declare global roll_kd is 1.0.
...
declare global forward_velocity_ki is 2.
declare global forward_velocity_kd is 2.5.

declare global lateral_velocity_kp is 4.
declare global lateral_velocity_ki is 2.
declare global lateral_velocity_kd is 2.5.
...
declare global altitude_up_kp is 15.
declare global altitude_up_ki is 1.5.//.
declare global altitude_up_kd is 10.

declare global altitude_down_kp is 5.
declare global altitude_down_ki is 0.01.//.
declare global altitude_down_kd is 35.

declare global max_climb_rate is 15.
declare global max_descent_rate is 5.

// Positional Control
declare global x_kp is 1.
declare global x_ki is 0.5.
declare global x_kd is 2.

declare global y_kp is 1.
...
declare global baseline_thrust is 350.